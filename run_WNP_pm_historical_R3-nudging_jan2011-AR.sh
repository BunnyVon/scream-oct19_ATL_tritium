...
if [ "${do_setup}" == "true" ]; then
    ...
    ./xmlchange SSTICE_DATA_FILENAME=/pscratch/sd/s/souravt/2023-08-15_12-54-04/HICCUP.sst_noaa.2011-01-02.nc
    ./xmlchange SSTICE_YEAR_START=2011,SSTICE_YEAR_END=2011,SSTICE_YEAR_ALIGN=2011
    ./xmlchange GLC_AVG_PERIOD=glc_coupling_period
    ./xmlchange DOUT_S=FALSE
    ./xmlchange RUN_STARTDATE=2011-01-02
...
!If using dtime=100s, 9 means 15 min.
    ...
    ncdata='/pscratch/sd/s/souravt/2023-08-15_12-54-04/HICCUP.atm_era5.2011-01-02.WNP_ne128x8pg2.L128.nc'

    !.......................................................
    ! nudging
    !.......................................................
    Nudge_Model          = .true.
    Nudge_Path           = '/global/cfs/projectdirs/m1867/souravt/ERA5_nudging/WNP_ne128x8pg2_201101/'
...
EOF
    ...
    finidat = '/pscratch/sd/s/souravt/e3sm_scratch/pm-cpu/SCREAMv0.ICRUELM.WNP_ne1024pg2_r0125_oRRS18to6v3.202311052044/run/SCREAMv0.ICRUELM.WNP_ne1024pg2_r0125_oRRS18to6v3.202311052044.elm.r.2011-01-02-00000.nc'
EOF
