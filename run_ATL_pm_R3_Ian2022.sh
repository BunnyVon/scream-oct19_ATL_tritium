...
if [ "${do_setup}" == "true" ]; then
    ...
    ./xmlchange SSTICE_DATA_FILENAME=/pscratch/sd/s/souravt/2024-03-25_15-11-40/HICCUP.sst_era5.2022-09-25.nc
    ./xmlchange SSTICE_YEAR_START=2022,SSTICE_YEAR_END=2022,SSTICE_YEAR_ALIGN=2022
    ./xmlchange GLC_AVG_PERIOD=glc_coupling_period
    ./xmlchange DOUT_S=FALSE
    ./xmlchange RUN_STARTDATE=2022-09-25
...
!If using dtime=100s, 9 means 15 min and 36 meanly hourly.
    ...
    ncdata='/pscratch/sd/s/souravt/2024-03-25_15-11-40/HICCUP.atm_era5.2022-09-25.ATL_ne128x8pg2.L128.nc'

    !.......................................................
    ! nudging
    !.......................................................
    Nudge_Model          = .true.
    Nudge_Path           = '/global/cfs/projectdirs/m1867/souravt/ERA5_nudging/AT_ne128x8pg2_202209/'
...
EOF
    ...
    finidat = '/pscratch/sd/s/souravt/e3sm_scratch/pm-cpu/SCREAMv0.ICRUELM.AT_ne1024pg2_r0125_oRRS18to6v3.202311021334/run/SCREAMv0.ICRUELM.AT_ne1024pg2_r0125_oRRS18to6v3.202311021334.elm.r.2022-09-23-00000.nc'
EOF
