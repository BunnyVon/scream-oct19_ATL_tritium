...
email_address="jianfeng.li@pnnl.gov"
...
case_name=SCREAMv0.${compset}.${resolution}.${date_string}_hist

# Set paths
code_root=/global/cfs/projectdirs/m3525/jli628/SCREAM_perlmutter_20220926
...
if [ "${do_setup}" == "true" ]; then
    ...
    ./xmlchange SSTICE_DATA_FILENAME=/global/cfs/projectdirs/m3525/jli628/EUS_smooth_initial_historical/HICCUP.sst_era5.2020-06-28.nc
    ./xmlchange SSTICE_YEAR_START=2020,SSTICE_YEAR_END=2020,SSTICE_YEAR_ALIGN=2020
    ./xmlchange GLC_AVG_PERIOD=glc_coupling_period
    ./xmlchange DOUT_S=FALSE
    ./xmlchange RUN_STARTDATE=2020-06-28
...
!If using dtime=100s, 9 means 15 min.
    nhtfrq=9,36,9
    mfilt=1,1,1
    avgflag_pertape='I','A','I'
    fincl1='PS','CAPE','CIN','PSL','PRECL','PRECC','PRECT','SHFLX','LHFLX','WINDSPD_10M','TS','SST','CLDLOW','CLDMED','CLDHGH', 'CLDTOT','TMCLDLIQ', 'TMCLDICE', 'TMRAINQM', 'TMCLDRIM', 'TMQ', 'TREFHT', 'QREFHT', 'FSNTOA','FLNT', 'FLNTC', 'FSNTOAC', 'FSNS', 'FSDS', 'FLNS', 'TMNUMLIQ','TMNUMICE','TMNUMRAI','TGCLDLWP','FSUTOA' ,'SWCF','LWCF','TGCLDIWP','TUQ','TVQ','FSDSC','FSNSC','FLNSC','FLDS','FLDSC', 'FSNT','FSNTC','FLUT','FLUTC','diag_equiv_reflectivity','HR','QRS','QRSC','QRL','QRLC','RCMTEND_SHOC_lh','latent_heating_3D','latent_cooling_3D','T','U','V','Q','Z3','OMEGA','RELHUM'
    fincl2='PS','CAPE','CIN','PSL','PRECL','PRECC','PRECT','SHFLX','LHFLX','WINDSPD_10M','TS','SST','CLDLOW','CLDMED','CLDHGH', 'CLDTOT','TMCLDLIQ', 'TMCLDICE', 'TMRAINQM', 'TMCLDRIM', 'TMQ', 'TREFHT', 'QREFHT', 'FSNTOA','FLNT', 'FLNTC', 'FSNTOAC', 'FSNS', 'FSDS', 'FLNS', 'TMNUMLIQ','TMNUMICE','TMNUMRAI','TGCLDLWP','FSUTOA' ,'SWCF','LWCF','TGCLDIWP','TUQ','TVQ','FSDSC','FSNSC','FLNSC','FLDS','FLDSC', 'FSNT','FSNTC','FLUT','FLUTC'
    fincl3='DYN_PNH','DYN_T','DYN_Q','DYN_U','DYN_V','DYN_OMEGA','DYN_PS','DYN_Z3'
    ncdata='/global/cfs/projectdirs/m3525/jli628/EUS_smooth_initial_historical/HICCUP.atm_era5.2020-06-28.EUS_ne128x8pg2.L128.nc'

    !.......................................................
    ! nudging
    !.......................................................
    Nudge_Model          = .true.
    Nudge_Path           = '/global/cfs/projectdirs/m3525/jli628/ERA5_nudging/ERA5_EUS_ne128x8pg2/'
    Nudge_File_Template  = 'ERA5_EUS_ne128x8pg2_L128.%y-%m-%d-%s.nc'
    ...
    Nudge_Hwin_lo        = 1.0
    Nudge_Hwin_hi        = 0.0
    Nudge_Hwin_lat0      = 37.5
    Nudge_Hwin_latWidth  = 23.
...
EOF
    ...
    cat <<EOF >> user_nl_elm
    finidat = '/global/cfs/projectdirs/m3525/jli628/EUS_smooth_initial_historical/r0125.elm.r.0051-01-01-00000.nc'
EOF
