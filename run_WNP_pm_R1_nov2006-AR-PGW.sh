...
# Set paths
##code_root=/global/project/projectdirs/m1867/souravt/scream-11apr23
...
if [ "${do_setup}" == "true" ]; then
    ...
    ./xmlchange SSTICE_DATA_FILENAME=/pscratch/sd/s/souravt/2024-04-22_15-35-02/HICCUP.sst_era5.2006-11-01.nc
    ./xmlchange SSTICE_YEAR_START=2006,SSTICE_YEAR_END=2006,SSTICE_YEAR_ALIGN=2006
    ./xmlchange GLC_AVG_PERIOD=glc_coupling_period
    ./xmlchange DOUT_S=FALSE
    ./xmlchange RUN_STARTDATE=2006-11-01
...
!If using dtime=100s, 9 means 15 min.
    ...
    mfilt=1,1
    avgflag_pertape='I','A'
    fincl1='CLDLIQ', 'CLDICE', 'RAINQM', 'CLDRIM', 'NUMLIQ','NUMICE','NUMRAI','TGCLDLWP', 'TGCLDIWP','BVRIM', 'T', 'U', 'V', 'Q', 'Z3', 'OMEGA', 'RELHUM'
    fincl2='PS','CAPE','CIN','PSL','PRECL','PRECC','PRECT','SHFLX','LHFLX','U10','TS','SST','CLDLOW','CLDMED','CLDHGH', 'CLDTOT','TMCLDLIQ', 'TMCLDICE', 'TMRAINQM', 'TMCLDRIM', 'TMQ', 'TREFHT', 'QREFHT', 'FSNTOA','FLNT', 'FLNTC', 'FSNTOAC', 'FSNS', 'FSDS', 'FLNS', 'TMNUMLIQ','TMNUMICE','TMNUMRAI','TGCLDLWP','FSUTOA' ,'SWCF','LWCF','TGCLDIWP','TUQ','TVQ','FSDSC','FSNSC','FLNSC','FLDS','FLDSC', 'FSNT','FSNTC','FLUT','FLUTC'

    ncdata='/pscratch/sd/s/souravt/2024-04-22_15-35-02/HICCUP.atm_era5.2006-11-01.WNP_ne128x8pg2.L128.nc'
    ...
    Model_Times_Per_Day  = 1728 !! should not be larger than 48 if dtime = 1800s
    Nudge_Uprof          = 2
    Nudge_Ucoef          = 1.
    Nudge_Vprof          = 2
    Nudge_Vcoef          = 1.
    ...
    Nudge_Hwin_lo        = 1.0
    Nudge_Hwin_hi        = 0.0
    Nudge_Hwin_lat0      = 36.5
    Nudge_Hwin_latWidth  = 29.0
    Nudge_Hwin_latDelta  = 0.5
    Nudge_Hwin_lon0      = 272.5
    Nudge_Hwin_lonWidth  = 45.
...
EOF
    ...
    cat <<EOF >> user_nl_elm
    !finidat = '/global/cfs/projectdirs/m3525/jli628/2022-09-28_06-43-59/SCREAMv0.ICRUELM.eus_ne128x8pg2_cori.202210031134.elm.r.2020-06-28-00000.nc'
EOF
