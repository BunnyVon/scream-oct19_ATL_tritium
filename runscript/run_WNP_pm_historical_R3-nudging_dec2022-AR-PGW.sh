...
if [ "${do_setup}" == "true" ]; then
    ...
    ./xmlchange SSTICE_DATA_FILENAME=/pscratch/sd/s/souravt/2024-06-04_14-25-28/HICCUP.sst_era5.2022-12-16.nc
    ...
    ./xmlchange RUN_STARTDATE=2022-12-16
...
!If using dtime=100s, 9 means 15 min.
    ...
    ncdata='/pscratch/sd/s/souravt/2024-06-04_14-25-28/HICCUP.atm_era5.2022-12-16.WNP_ne128x8pg2.L128.nc'

    !.......................................................
    ! nudging
    !.......................................................
    Nudge_Model          = .true.
    Nudge_Path           = '/global/cfs/projectdirs/m1867/souravt/ERA5_nudging_PGW/WNP_ne128x8pg2_202212/'
...
EOF
    ...
    finidat = '/pscratch/sd/s/souravt/e3sm_scratch/pm-cpu/SCREAMv0.ICRUELM.WNP_ne1024pg2_r0125_oRRS18to6v3.202311171359/run/SCREAMv0.ICRUELM.WNP_ne1024pg2_r0125_oRRS18to6v3.202311171359.elm.r.2022-12-16-00000.nc'
EOF
