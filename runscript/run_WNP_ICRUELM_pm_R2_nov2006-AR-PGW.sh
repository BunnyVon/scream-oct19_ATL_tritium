...
if [ "${do_setup}" == "true" ]; then
    ...
    ./xmlchange DATM_CLMNCEP_YR_START=2003,DATM_CLMNCEP_YR_END=2006,DATM_CLMNCEP_YR_ALIGN=2003
    ./xmlchange RUN_STARTDATE=2003-11-01
    ./xmlchange START_TOD=0

    cat <<EOF >> user_nl_elm
    fsurdat = '/pscratch/sd/s/souravt/RRM_setup_tutorial/RRM_generation_inputs/surfdata_WNP_ne128x8pg2_simyr2010_c230411.nc'
    finidat = '/global/cfs/cdirs/m1867/souravt/r0125.elm.r.0051-01-01-00000.nc'
EOF
...
sed -i 's#/global/cfs/cdirs/e3sm/inputdata/atm/datm7/atm_forcing.datm7.cruncep_qianFill.0.5d.v7.c160715/#/global/cfs/projectdirs/m1867/souravt/ERA5_nudging_PGW/ERA5_forcing/hourly/#g' user_datm.streams.txt.CLMCRUNCEPv7*
