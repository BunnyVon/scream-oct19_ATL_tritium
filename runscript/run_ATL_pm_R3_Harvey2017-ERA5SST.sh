...
if [ "${do_setup}" == "true" ]; then
    ...
    ./xmlchange SSTICE_DATA_FILENAME=/pscratch/sd/s/souravt/2024-06-03_14-49-28/HICCUP.sst_era5.2017-08-24.nc
    ./xmlchange SSTICE_YEAR_START=2017,SSTICE_YEAR_END=2017,SSTICE_YEAR_ALIGN=2017
    ./xmlchange GLC_AVG_PERIOD=glc_coupling_period
    ./xmlchange DOUT_S=FALSE
    ./xmlchange RUN_STARTDATE=2017-08-24
...
!If using dtime=100s, 9 means 15 min and 36 meanly hourly.
    ...
    ncdata='/pscratch/sd/s/souravt/2024-06-03_14-49-28/HICCUP.atm_era5.2017-08-24.ATL_ne128x8pg2.L128.nc'
...
EOF
    ...
    finidat = '/pscratch/sd/s/souravt/e3sm_scratch/pm-cpu/SCREAMv0.ICRUELM.AT_ne1024pg2_r0125_oRRS18to6v3.202406031532/run/SCREAMv0.ICRUELM.AT_ne1024pg2_r0125_oRRS18to6v3.202406031532.elm.r.2017-08-24-00000.nc'
EOF
