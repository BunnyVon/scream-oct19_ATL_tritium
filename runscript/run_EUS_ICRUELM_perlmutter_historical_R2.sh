...
case_name=SCREAMv0.${compset}.${resolution}.${date_string}_historical
...
if [ "${do_setup}" == "true" ]; then
    ...
    ./xmlchange DATM_CLMNCEP_YR_START=2020,DATM_CLMNCEP_YR_END=2020,DATM_CLMNCEP_YR_ALIGN=2020
    ./xmlchange RUN_STARTDATE=2017-06-28
    ./xmlchange START_TOD=0
    ./xmlchange CCSM_CO2_PPMV=414.891

    cat <<EOF >> user_nl_elm
    fsurdat = '/global/cfs/projectdirs/m3525/jli628/RRM_generation_smooth/surfdata_EUS_ne128x8pg2_simyr2010_c221206.nc'
    finidat = '/global/cfs/projectdirs/m3525/jli628/RRM_generation_smooth/r0125.elm.r.0051-01-01-00000.nc'
EOF
...
cd ${case_root}
sed -i 's#/global/cfs/cdirs/e3sm/inputdata/atm/datm7/atm_forcing.datm7.cruncep_qianFill.0.5d.v7.c160715/#/global/cfs/projectdirs/m3780/jli628/ERA5_forcing_historical/#g' user_datm.streams.txt.CLMCRUNCEPv7*
