...
if [ "${do_setup}" == "true" ]; then
    ...
    ./xmlchange SSTICE_DATA_FILENAME=/pscratch/sd/s/souravt/2023-08-21_14-09-14/HICCUP.sst_noaa.2015-01-31.nc
    ./xmlchange SSTICE_YEAR_START=2015,SSTICE_YEAR_END=2015,SSTICE_YEAR_ALIGN=2015
    ./xmlchange GLC_AVG_PERIOD=glc_coupling_period
    ./xmlchange DOUT_S=FALSE
    ./xmlchange RUN_STARTDATE=2015-01-31
...
!If using dtime=100s, 9 means 15 min.
    ...
    ncdata='/pscratch/sd/s/souravt/2023-08-21_14-09-14/HICCUP.atm_era5.2015-01-31.WNP_ne128x8pg2.L128.nc'

    !.......................................................
    ! nudging
    !.......................................................
    Nudge_Model          = .true.
    Nudge_Path           = '/global/cfs/projectdirs/m1867/souravt/ERA5_nudging/WNP_ne128x8pg2_201502/'
...
EOF
    ...
    finidat = '/pscratch/sd/s/souravt/e3sm_scratch/pm-cpu/SCREAMv0.ICRUELM.WNP_ne1024pg2_r0125_oRRS18to6v3.202311081712/run/SCREAMv0.ICRUELM.WNP_ne1024pg2_r0125_oRRS18to6v3.202311081712.elm.r.2015-01-28-00000.nc'
EOF
