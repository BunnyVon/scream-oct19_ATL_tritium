...
if [ "${do_setup}" == "true" ]; then
    ...
    ./xmlchange SSTICE_DATA_FILENAME=/pscratch/sd/s/souravt/2024-02-06_13-24-26/HICCUP.sst_noaa.2017-08-23.nc
    ...
    ./xmlchange RUN_STARTDATE=2017-08-23
...
!If using dtime=100s, 9 means 15 min and 36 meanly hourly.
    ...
    ncdata='/pscratch/sd/s/souravt/2024-02-06_13-24-26/HICCUP.atm_era5.2017-08-23.ATL_ne128x8pg2.L128.nc'
    ...
    Model_Times_Per_Day  = 432 !! should not be larger than 48 if dtime = 1800s
    Nudge_Uprof          = 2
    Nudge_Ucoef          = 1.
    Nudge_Vprof          = 2
    Nudge_Vcoef          = 1.
...
EOF
    ...
    finidat = '/pscratch/sd/s/souravt/e3sm_scratch/pm-cpu/SCREAMv0.ICRUELM.AT_ne1024pg2_r0125_oRRS18to6v3.202402071151/run/SCREAMv0.ICRUELM.AT_ne1024pg2_r0125_oRRS18to6v3.202402071151.elm.r.2017-08-23-00000.nc'
EOF
