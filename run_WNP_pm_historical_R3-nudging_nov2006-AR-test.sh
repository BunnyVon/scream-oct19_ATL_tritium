...
if [ "${do_setup}" == "true" ]; then
    ...
    ./xmlchange SSTICE_DATA_FILENAME=/pscratch/sd/s/souravt/2023-04-14_15-21-04/HICCUP.sst_noaa.2006-11-01.nc
...
!If using dtime=100s, 9 means 15 min.
    ...
    ncdata='/pscratch/sd/s/souravt/2023-04-14_15-21-04/HICCUP.atm_era5.2006-11-01.WNP_ne128x8pg2.L128.nc'

    !.......................................................
    ! nudging
    !.......................................................
    Nudge_Model          = .true.
    Nudge_Path           = '/global/cfs/projectdirs/m1867/souravt/ERA5_nudging/WNP_ne128x8pg2_200611/'
...
EOF
    ...
    finidat = '/pscratch/sd/s/souravt/e3sm_scratch/pm-cpu/SCREAMv0.ICRUELM.WNP_ne1024pg2_r0125_oRRS18to6v3.202310201205/run/SCREAMv0.ICRUELM.WNP_ne1024pg2_r0125_oRRS18to6v3.202310201205.elm.r.2006-11-01-00000.nc'
EOF
